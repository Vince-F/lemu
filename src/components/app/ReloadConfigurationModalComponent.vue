<template>
  <v-dialog
    ...
    <v-card>
      ...
      <v-card-text>
        The configuration has been modified from outside of LEMU. However 
        you have also pending changes.
        Would you like to keep your changes or reload?
      </v-card-text>
      ...
      <v-card-actions>
        ...
        >
          Reload file and discard changes
        </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog> 
